...
urlpatterns = [
    ...
    path('albums/<str:album_name>/upload/', 
        PictureUpload.as_view(), name='upload_pictures'),
    ...
    # single picture
    path('albums/<str:album_name>/<int:pk>/',
        PictureDetails.as_view(), name='single_picture'),
    # delete single picture
    path('albums/<str:album_name>/<int:pk>/delete/',
        PictureDelete.as_view(), name='delete_picture'),
    # update single picture
    path('albums/<str:album_name>/<int:pk>/update/',
        PictureUpdate.as_view(), name='update_picture'),
]